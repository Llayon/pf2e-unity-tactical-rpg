...
namespace PF2e.Core
{
    ...
    public class CombatEventBus : MonoBehaviour
    {
        ...
        public delegate void HealingAppliedHandler(in HealingAppliedEvent e);
        ...
        public delegate void HazardTriggeredHandler(in HazardTriggeredEvent e);
        ...
        public event HealingAppliedHandler OnHealingAppliedTyped;
        ...
        public event HazardTriggeredHandler OnHazardTriggeredTyped;
        ...
        public void PublishHealingApplied(in HealingAppliedEvent ev)
        {
            OnHealingAppliedTyped?.Invoke(in ev);
        }
        ...
        public void PublishHazardTriggered(in HazardTriggeredEvent ev)
        {
            OnHazardTriggeredTyped?.Invoke(in ev);
        }
