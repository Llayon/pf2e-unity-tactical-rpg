...
namespace PF2e.Presentation
{
    ...
    public class CombatLogController : MonoBehaviour
    {
        ...
        private const float LogLineFontSize = 21f;
        private const float LogLineCharacterSpacing = 0.18f;
        private const float LogLineWordSpacing = 2.8f;
        ...
        private static void ApplyLineTypography(TMP_Text line)
        {
            ...
            CombatUiTypography.ApplyWithFont(
                ...
                wordSpacing: LogLineWordSpacing);
