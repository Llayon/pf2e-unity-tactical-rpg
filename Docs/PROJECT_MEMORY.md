...
- Combat presents: turn HUD, initiative bar, combat log (pooled TMP lines, wrap-aware row heights, retention cap `maxLines=300` with notice), floating damage, modal Shield Block reaction prompt, and end-of-encounter panel.
