...
2. Hazard presentation follow-up: wire `HazardLogForwarder` into the authored combat scenes cleanly, isolating that scene change from the remaining `SampleScene`/HUD diff noise.
