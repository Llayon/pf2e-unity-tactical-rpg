...
2. Add one PlayMode regression that verifies typed combat-end payload consistency (`EncounterResult` + panel text path) under both victory and manual abort flows.
