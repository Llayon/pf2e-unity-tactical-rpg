...
1. Polish ranged strike preview risk UX with compact iconography/token presentation (especially combined cover + concealment) without bloating hover text.
