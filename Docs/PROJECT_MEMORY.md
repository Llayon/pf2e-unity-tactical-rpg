...
- Authoring guardrail: unknown `actorName` entries in encounter initiative override lists now emit a warning at Start Encounter (`[EncounterFlow] Initiative override actor not found: 'Name'`) while preserving normal combat startup.
