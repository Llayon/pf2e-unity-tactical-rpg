...
2. Add one EditMode unit test for panel text mapping helper semantics (`EncounterResult -> title/subtitle`) to reduce UI text regressions without scene startup cost.
